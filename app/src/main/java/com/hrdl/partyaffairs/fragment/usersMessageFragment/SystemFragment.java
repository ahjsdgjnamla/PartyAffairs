...
/**
 * Created by zhangwei on 2018/9/12.
 * 用户系统消息
 */
public class SystemFragment extends BaseLazyFragment implements View.OnClickListener, SystemMessageAdapter.OnItemClickListener {
    ...
    /*public void getNewsData() {
        ...
        OkGo.<String>get(HTTPJSONConstant.News_list)
                .tag(TAG)
                .params("messageType", Const.SYSTEM_MESSAGE_TYPE)
                ...
                .execute(new MStringCallback() {
                    ...
                    public void onFinish() {
                        //更新全选和取消或是隐藏状态
                        CallBackUtils.doCallBackMethod("oneUpData");
                    }
                });
    }*/
